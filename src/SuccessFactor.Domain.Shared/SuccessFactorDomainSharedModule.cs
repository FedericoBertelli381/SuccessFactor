...
public class SuccessFactorDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SuccessFactorGlobalFeatureConfigurator.Configure();
        SuccessFactorModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SuccessFactorDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SuccessFactorResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SuccessFactor");

            options.DefaultResourceType = typeof(SuccessFactorResource);
        ...
        {
            options.MapCodeNamespace("SuccessFactor", typeof(SuccessFactorResource));
        });
    }
}
